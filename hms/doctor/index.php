...
$_SESSION['errmsg']="اسم المستخدم وكلمة المرور خطأ";
$extra="index.php";
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
exit();
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html">	<h2 align="right"> نظام ادارة مستشفى.. دخول الاطباء</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post" dir="rtl">
						<fieldset>
							...
							<p>
								ادخل اسم المستخدم وكلمة المرور.<br />
							...
							<div class="form-actions">
								...
								<button type="submit" class="btn btn-primary pull-right" name="submit">
									دخــول <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
