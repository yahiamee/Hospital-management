...
{
$_SESSION['msg1']="كلمة المرور الحالية غير صحيحة";
}
}
?>
<!DOCTYPE html>
...
{
alert("من فضلك اكتب تأكيد كلمة المرور الجديدة");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle" align="right">تغيير كلمة المرور</h1>
																	</div>
								<ol class="breadcrumb">
								
									<li class="active">
										<span align="right"> تغيير كلمة المرور</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title" align="right">تغيير كلمة المرور</h5>
												</div>
