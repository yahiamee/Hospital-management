...
{
alert("من فضلك أكتب كلمة المرور الحالية");
document.chngpwd.cpass.focus();
return false;
}
else if(document.chngpwd.npass.value=="")
{
alert("من فضلك أكتب كلمة المرور الجديدة");
document.chngpwd.npass.focus();
return false;
}
else if(document.chngpwd.cfpass.value=="")
{
alert("من فضلك أكتب تأكيد كلمة المرور");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle" align="right">تعديل كلمة المرور</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span></span>
									...
									<li class="active">
										<span align="right">تعديل كلمة المرور</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title" align="right">تعديل كلمة المرور</h5>
												</div>
