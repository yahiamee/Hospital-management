	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2 align="right">تسجيل المرضى</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();" dir="rtl">
						<fieldset>
							<legend>
								
							</legend>
							<p align="right">
								ادخل المعلومات الشخصية التالية
							</p>
