								...
								<div class="col-md-12">
									...
									<div class="row margin-top-30">
										<div class="col-lg-8 col-md-12">
											...
											<form action="baybook.php" method="post">
<div id="ac" dir="rtl">
<span> </span><input type="number" class="form-control" name="type" value="" placeholder="رقم الغرفة" ><br>
<span> <select name="typebay" class="form-control">
<option value=""> ..اضغط لاختيار نوع الدفع..</option>
<option value="دفع مباشر">دفع مباشر </option>
<option value="حساب بنكي">حساب بنكي </option>
<option value="بطاقة صراف"> بطاقة صراف</option>
...
<button class="btn btn-success btn-block btn-large" class="btn" name="save2"><i class="icon icon-save icon-large"></i>تاكيد</button>
...
{
    $sql = "INSERT INTO bay (type, typebay, amount, card_no)
    VALUES ('".$_POST["type"]."','".$_POST["typebay"]."','".$_POST["amount"]."','".$_POST["card_no"]."')";
if($sql)
{
