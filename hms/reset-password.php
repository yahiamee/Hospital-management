...
if ($query) {
echo "<script>alert('تم تعديل كلمة المرور بنجاح');</script>";
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2 align="right"> تعديل كلمة المرور</h2></a>
				</div>

				<div class="box-login">
					<form class="form-login" name="passwordreset" method="post" onSubmit="return valid();" dir="rtl">
						<fieldset>
							<legend align="right">
								تعديل كلمة المرور
							</legend>
							<p align="right">
								تعديل كلمة المرور<br />
...
<div class="form-group">
<span class="input-icon">
<input type="password" class="form-control"  id="password_again" name="password_again" placeholder="تأكيد كلمة المرور" required>
<i class="fa fa-lock"></i> </span>
</div>
							...
							<div class="form-actions">
								...
								<button type="submit" class="btn btn-primary pull-right" name="change">
									تعديــل <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
